...
class ManyModelValidationError(BaseFlaskPydanticException):
    ...
    def errors(self): # -> List[dict[Unknown, Unknown]]:
        ...
...
class ValidationError(BaseFlaskPydanticException):
    ...
    def __init__(self, body_params: Optional[List[dict]] = ..., form_params: Optional[List[dict]] = ..., path_params: Optional[List[dict]] = ..., query_params: Optional[List[dict]] = ...) -> None:
        ...
